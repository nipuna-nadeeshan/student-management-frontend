...
function App() {
  ...
  useEffect(() => {
    if (!studentLoaded) {
      axios.get("https://student-management-backend-pd7w.onrender.com/students").then((res) => {
  ...
  const handleAddStudent = () => {
    ...
    axios.post("https://student-management-backend-pd7w.onrender.com/students", newStudent)
      .then(() => {
        alert("Student Added");
  ...
  const handleUpdateStudent = () => {
    axios.put(`https://student-management-backend-pd7w.onrender.com/students/${selectedStudent.reg}`, selectedStudent)
      .then(() => {
            ...
            >
              ...
              <div className="flex space-x-2 w-16">
                ...
                <button className="text-red-500 hover:text-red-700" onClick={() => {
                  ...
                  axios.delete(`https://student-management-backend-pd7w.onrender.com/students/${std.reg}`)
                    .then(() => {
                      setStudentsLoaded(false);
                    });
                }}>
